...
public class BuildFileDAO implements BuildDAO{
	...
	public void initDeck() {
		try (
				InputStream is = wac.getServletContext().getResourceAsStream(FILE_NAME_Deck);
	...
	public void initWheel() {
		try (
				InputStream is = wac.getServletContext().getResourceAsStream(FILE_NAME_Wheel);
				BufferedReader buf = new BufferedReader(new InputStreamReader(is));
			) {
			String line = buf.readLine();
			while ((line = buf.readLine()) != null) {
...
//	@Override
//	public List<Wheel> getWheelsByBrand(String wheelBrand) {
...
//	}
	...
	public void initBearing() {
		try (
				InputStream is = wac.getServletContext().getResourceAsStream(FILE_NAME_Bearing);
				BufferedReader buf = new BufferedReader(new InputStreamReader(is));
			) {
			String line = buf.readLine();
			while ((line = buf.readLine()) != null) {
	...
	public void initTrucks() {
		try (
				InputStream is = wac.getServletContext().getResourceAsStream(FILE_NAME_Truck);
				BufferedReader buf = new BufferedReader(new InputStreamReader(is));
			) {
			String line = buf.readLine();
			while ((line = buf.readLine()) != null) {
...
//	@Override
//	public List<Deck> getDeckByUrl(String url) {
//		List<Deck> d = new ArrayList<>();
//		for (Deck deck : decks) {
//			if (deck.getUrl().equalsIgnoreCase(url)) {
//				d.add(deck);
